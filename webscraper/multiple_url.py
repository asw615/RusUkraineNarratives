...
csv_files = glob.glob("/Users/sorenmeiner/Library/CloudStorage/OneDrive-Aarhusuniversitet/CogComm exam/webscraper/URL_TO_SCRAPE/tass/tass.csv")
...
for i in article_list:
    ...
    file_path = '/Users/sorenmeiner/Library/CloudStorage/OneDrive-Aarhusuniversitet/CogComm exam/webscraper/json_data/russian_articles01/tass/{}'.format(article.filename)
...
for curr_file in glob.glob("/Users/sorenmeiner/Library/CloudStorage/OneDrive-Aarhusuniversitet/CogComm exam/webscraper/json_data/russian_articles01/tass/*.json"):
...
pdf_no_duplicates.to_csv("csv_data/tass.csv",index=False)